...
export interface EndpointPayload {
  ...
  delay: number;
  conditions: import('../types').ConditionRule[];
}
...
export const mockApiApi = {
  ...
  saveAPIDraft: (projectId: string, id: string, data: EndpointPayload) =>
    api.put<ApiResponse<MockAPI>>(`/projects/${projectId}/apis/${id}/draft`, data),
  publishAPIDraft: (projectId: string, id: string, data?: EndpointPayload) =>
    api.post<ApiResponse<MockAPI>>(`/projects/${projectId}/apis/${id}/publish`, data),
  discardAPIDraft: (projectId: string, id: string) =>
    api.delete<ApiResponse<MockAPI>>(`/projects/${projectId}/apis/${id}/draft`),
  deleteAPI: (projectId: string, id: string, force = false) =>
    api.delete<ApiResponse<void>>(`/projects/${projectId}/apis/${id}`, {
